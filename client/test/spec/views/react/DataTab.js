    ...
    describe('React', function () {
        describe('DataTab', function () {
            var component = null,
                definitions = [];
            beforeEach(function () {
                definitions = [{ title: 'definition one' }, { title: 'definition two' }];
                component = TestUtils.renderIntoDocument(React.createElement(DataTab, { title: 'test title', definitions: definitions }));
            });
