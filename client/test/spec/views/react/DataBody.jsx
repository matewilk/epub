define(function(require){
    ...
    describe('React', function(){
        describe('DataBody', function(){
            ...
            beforeEach(function(){
                definitions = [
                    {partOfSpeech: 'noun', source: 'very wise dictionary', definition: 'definition one'},
                    {partOfSpeech: 'noun', source: 'even wiser dictionary', definition: 'definition two'}
                ]
                component = TestUtils.renderIntoDocument(
                    <DataBody definitions={definitions}/>
                );
            });
